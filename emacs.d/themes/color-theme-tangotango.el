...
(defun color-theme-tangotango ()
  ...
  (color-theme-install
   '(color-theme-tangotango
     ...
     ;; added by paw
     ;; rainbow-delimiters; Colors are from zenburn theme
     ...
     ;; fra zenburn
     (magit-section-title ((t (:foreground "#cc9393"))))
     (magit-branch ((t (:foreground "#8cd0d3"))))
     (magit-item-highlight ((t (:foreground "#8cd0d3"))))
